...
public class NewRecievedPaysDialogCardAdapter extends RecyclerView.Adapter<NewRecievedPaysDialogCardAdapter.ViewHolderDialog>{
    ...
    private NewRecievedPaysDialogCardAdapter.OnClickListener mOnClickListener; // Qui hagi de repintar la ReciclerView
    ...
    private NewRecievedPaysDialogCardAdapter.OnClickAcceptListener mOnClickAcceptListener; // Qui hagi de repintar la ReciclerView
    ...
    // Constructor
    public NewRecievedPaysDialogCardAdapter(ArrayList<MemberDebt> userList) {
        this.mDebts = userList; // no fa new (La llista la manté el ViewModel)

    }

    public void setOnClickAcceptListener(NewRecievedPaysDialogCardAdapter.OnClickAcceptListener listener) {
    ...
    @NonNull
    @Override
    public NewRecievedPaysDialogCardAdapter.ViewHolderDialog onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new NewRecievedPaysDialogCardAdapter.ViewHolderDialog(view);
    }

    /* Mètode cridat per cada ViewHolder de la RecyclerView */
    @Override
    public void onBindViewHolder(@NonNull NewRecievedPaysDialogCardAdapter.ViewHolderDialog holder, int position) {
    ...
    public static class ViewHolderDialog extends RecyclerView.ViewHolder {
        ...
        public void bind(final MemberDebt md, NewRecievedPaysDialogCardAdapter.OnClickListener listener, NewRecievedPaysDialogCardAdapter.OnClickAcceptListener listenerAcc) { //poner foto y textos
            mDebtPrice.setText(md.getUserDebt() + " € de " + UserContactsLocal.getInstance().getContact(md.getUserID()));
